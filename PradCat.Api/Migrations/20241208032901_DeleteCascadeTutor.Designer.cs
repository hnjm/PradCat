...
namespace PradCat.Api.Migrations
{
    ...
    [Migration("20241208032901_DeleteCascadeTutor")]
    partial class DeleteCascadeTutor
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PradCat.Api.Models.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("PradCat.Domain.Entities.Appointment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PradCat.Domain.Entities.Veterinarian", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PradCat.Domain.Entities.Appointment", b =>
                {
                    b.HasOne("PradCat.Domain.Entities.Cat", "Cat")
                        .WithMany("Appointments")
                        .HasForeignKey("CatId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PradCat.Domain.Entities.Veterinarian", "Veterinarian")
                        .WithMany("Appointments")
            ...
            modelBuilder.Entity("PradCat.Domain.Entities.Tutor", b =>
                {
                    b.HasOne("PradCat.Api.Models.AppUser", null)
                        .WithOne()
                        .HasForeignKey("PradCat.Domain.Entities.Tutor", "AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
