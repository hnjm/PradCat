    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Natalia Oliveira", "Oftalmologista" },
                    { 2, "Luana Soares", "Oncologista" },
                    { 3, "Rafael Venâncio", "Dentista" },
                    { 4, "Samuel Silva", "Clínico Geral" }
                });

            migrationBuilder.CreateIndex(
                name: "IX_Appointment_CatId",
                table: "Appointment",
                column: "CatId");
